...
import BarrelVid from '../media/barrel.mp4'
import BarrelIcon from '../media/knobcreek.jpeg'
      ...
      <div className="project-content">
        <Fade left>
          <div className="project-description">
            ...
            <p className="blurb">A recreation of KnobCreek's given design specifications.</p>
